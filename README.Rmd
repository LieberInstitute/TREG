...
![Distribution of ranks of a gene of High and Low Invariance](man/figures/fig1_rank_violin_demo.png){width=50%}
...
genes should be filtered by maximum proportion of zeros within a groups of cells.
