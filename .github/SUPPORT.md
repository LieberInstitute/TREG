# Getting help with `TREG`

Thank you for using `TREG`!
...
* Bioconductor software related questions, such as bug reports and feature
  requests, should be addressed in the appropriate `Bioconductor/TREG`
...
* Bioconductor software usage questions should be addressed in the
  ...
  to use the
  [appropriate package tag](https://support.bioconductor.org/tag/TREG),
...
[search issues and pull requests](https://github.com/LieberInstitute/TREG/issues)
