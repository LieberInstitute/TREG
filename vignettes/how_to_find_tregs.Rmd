...
knitr::kable(ct_names, caption = "Table 1: Cell Type names and corresponding acromyms used in this dataset", label = "cell_type_acronyms")
```
...
Now we are working with the cell type resolution we are interested in.
...
dataset is 88% sparse. We can illustrate this in the heat map which is very blue (Figure \@ref(fig:examineSparsity)).

```{r "examineSparsity", fig.cap = "Heatmap of the snRAN-seq counts. Illustrates sparseness of unfiltered data."}
...
```{r "top50_filter_heatmap", fig.cap = "Heatmap of the snRAN-seq counts. With top 50% filtering the data becomes less sparse."}
...
```{r "prop_zero_filter_heatmap", fig.cap = "Heatmap of the snRAN-seq counts after Proption Zero filtering."}
