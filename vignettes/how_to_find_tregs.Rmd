...
Here we download a public data single nucleus RNA-seq (snRNA-seq) data that we'll use as our example `r Citep(bib[['tran2021']])`. It takes 1.01 GB of RAM memory to load this object.
