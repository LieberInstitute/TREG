...
knitr::kable(ct_names, caption = "Cell type names and corresponding acromyms used in this dataset", label = "acronyms")
```
...
```
The heatmap is mostly blue, indicating low values
...
```
We are seeing more non-blue (Figure \@ref(fig:top50FilterHeatmap))!  
...
More non-blue means more non-zero values for the Rank Invariance calculation,
