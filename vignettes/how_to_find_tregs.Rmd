...
**Filter and refine data to cell types of interest.**  
...
dataset is 88% sparse. We can illustrate this in the heat map which is very blue (Figure \@ref(fig:exampleSparsity)).

```{r "examine_sparsity", fig.cap = "Heatmap of the snRAN-seq counts. Illistrates sparseness of unfiltered data."}
